...
# Create a .gitignore file with the folliwng contents: __pycache__/
...
# git add -A
# git commit -m "Submit my project 0: degrees"
# git push origin main:ai50/projects/2020/x/degrees
#
##
...
def shortest_path(source, target):
    ...
    # Initialize frontier to include the source node
    start = Node(state=make_first_node(source), parent=None, action=None)
    frontier.add(start)
...
def make_first_node(source):
    return (next(iter(people[source]["movies"])), source)
